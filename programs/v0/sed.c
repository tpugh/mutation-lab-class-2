...
/* The occurence of argv[0] is cahnged to myname to remove nondeterminism by 
Amit Goel on 30th August , 2001 */
     ...
     char **argv;
{
 ...
 /* Commented By Amit Goel  on 30th August 2001to remove differences 
 between instrumented and non instrumented versions output */
 /* myname = argv[0]; */
 myname = "Executable"; /* Added by Amit Goel on 30th August 2001 */
