...
/*
   EDITED config.h file for SIR subject: sed
   autoconf and autoheader generate sources of
   non-determinism
*/
...
/* Hacked by Kyle R. Murphy to remove nondeterminism for SIR*/
#define VERSION "sir-default"
